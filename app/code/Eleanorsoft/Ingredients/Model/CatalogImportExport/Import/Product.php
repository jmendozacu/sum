...
namespace Eleanorsoft\Ingredients\Model\CatalogImportExport\Import;
...
class Product extends \Magento\CatalogImportExport\Model\Import\Product
{
    ...
    protected $_linkNameToId = [
        ...
        '_ingredients_' => \Eleanorsoft\Ingredients\Model\Catalog\Product\Link::LINK_TYPE_INGREDIENTS
    ];
    ...
    protected $_fieldsMap = [
        ...
        '_ingredients_sku' => 'ingredients_skus',
        '_ingredients_position' => 'ingredients_position',
    ];

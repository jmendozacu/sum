<?php
namespace Aheadworks\Sarp\Block\Adminhtml\Page\Menu;

use Aheadworks\Sarp\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Sarp\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Sarp::page/menu/item.phtml';

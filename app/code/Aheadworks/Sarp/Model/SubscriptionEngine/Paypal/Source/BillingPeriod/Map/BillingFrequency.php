...
namespace Aheadworks\Sarp\Model\SubscriptionEngine\Paypal\Source\BillingPeriod\Map;
 ...
 * @package Aheadworks\Sarp\Model\SubscriptionEngine\Paypal\Source\BillingPeriod\Map
 */
    ...
    public function toOptionMapArray()
    {
        if (!$this->optionMap) {
            $this->optionMap = [
                ...
                BillingPeriodSource::SEMI_MONTH => $this->getOptionArray(1),

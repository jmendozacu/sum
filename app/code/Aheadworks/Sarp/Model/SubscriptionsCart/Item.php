...
use Aheadworks\Sarp\Api\Data\SubscriptionsCartItemExtensionInterface;
use Aheadworks\Sarp\Model\ResourceModel\SubscriptionsCart\Item as ItemResource;
use Aheadworks\Sarp\Model\SubscriptionsCart\Item\Validator as ItemValidator;
 ...
 */
class Item extends AbstractModel implements SubscriptionsCartItemInterface
{
    /**
     * @var ItemValidator
     */
    ...
    {
        return $this->getData(self::TAX_CALCULATION_ITEM_ID);
    }
    ...
    {
        return $this->setData(self::TAX_CALCULATION_ITEM_ID, $taxCalculationItemId);
    }
     ...
     * {@inheritdoc}
     */
    public function setExtensionAttributes(SubscriptionsCartItemExtensionInterface $extensionAttributes)
    {

...
define(['jquery','underscore','Magento_Catalog/js/price-box'], function ($, us) 
{
	'use strict';

    $.widget('ec.priceBox', $.mage.priceBox, 
    {
    	reloadPrice: function reDrawPrices() 
    	{
    		...
    		{
                price.final = us.reduce(price.adjustments, function (memo, amount) 
                {
                	return memo + amount;

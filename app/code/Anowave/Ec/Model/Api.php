...
class Api
{
	...
	{
		$value = $this->config->getValue('ec/api/google_adwords_conversion_id', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStore()->getCode());
	...
	{
		$value = $this->config->getValue('ec/api/google_adwords_conversion_label', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStore()->getCode());

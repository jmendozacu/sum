...
use Atak\Praise\Model\ItemFactory;
...
class Index extends \Magento\Backend\App\Action
{
	...
	*/
	 ...
	 * News model factory
	 *
	 * @var \Atak\Praise\Model\ItemFactory
	 */
	...
	{
		return $this->_authorization->isAllowed('Atak_Praise::praise_manage');
	}
	...
	protected function _setPageData()
	{
		...
		$resultPage->getConfig()->getTitle()->prepend((__('Praise')));
